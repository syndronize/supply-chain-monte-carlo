    ...
    <div class="container-fluid my-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-lg">
                        <a href="{{route('step2analisa')}}" class="btn btn-light" ><i class="fa fa-arrow-left"></i> Previous</a>
                        
                        <a href="{{route('step4analisa')}}" class="btn btn-light">Next 
                ...
                <table class="table table-bordered table-striped text-center align-center my-3">
                    ...
                    <tr>
                            ...
                            <th colspan="12">Probabilitas Kumulatif</th>
                        </tr>
                        <tr>
                            <th>Januari</th>
                            <th>Februari</th>
                    ...
                    @php
                        ...
                        <tr>
                            ...
                            @foreach($item['probabilitas'] as $i => $value)
                                ...
                                <td>{{number_format($value+$totalProb,2)}}</td>
                                @php
                                if($i != 12){
                                    $totalProb += $value;
                                }
